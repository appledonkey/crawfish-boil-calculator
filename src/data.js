...
export const RECIPES = [
  { id: "classic", title: "Classic Louisiana Crawfish Boil", time: "60 min", difficulty: "Easy", category: "boil",
    ...
    products: [
      { name: "Zatarain's Crawfish Boil Seasoning", query: "Zatarains crawfish boil seasoning" },
      { name: "Louisiana Liquid Crab Boil", query: "Louisiana liquid crab boil concentrate" },
      { name: "80-Qt Boiling Pot w/ Basket", query: "80 qt crawfish boiling pot basket" },
      { name: "Crawfish Paddle", query: "crawfish boil paddle long wooden" },
    ] },
  { id: "viet-cajun", title: "Viet-Cajun Crawfish Boil", time: "60 min", difficulty: "Medium", category: "boil",
    ...
    products: [
      { name: "Cajun Seasoning Blend", query: "cajun seasoning Tony Chacheres" },
      { name: "Sriracha Hot Sauce", query: "sriracha hot chili sauce" },
      { name: "Garlic Press", query: "garlic press stainless steel" },
    ] },
  { id: "garlic-butter", title: "Garlic Butter Crawfish", time: "15 min", difficulty: "Easy", category: "boil",
    ...
    products: [
      { name: "Garlic Press", query: "garlic press stainless steel" },
      { name: "Louisiana Hot Sauce", query: "Louisiana hot sauce original" },
    ] },
  { id: "etouffee", title: "Crawfish Etouffee", time: "45 min", difficulty: "Medium", category: "cajun",
    ...
    products: [
      { name: "Cajun Seasoning", query: "cajun seasoning Tony Chacheres" },
      { name: "Dutch Oven", query: "enameled dutch oven 5 qt" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
  { id: "monica", title: "Crawfish Monica", time: "30 min", difficulty: "Easy", category: "cajun",
    ...
    products: [
      { name: "Creole Seasoning", query: "Tony Chacheres creole seasoning" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
  { id: "fettuccine", title: "Crawfish Fettuccine", time: "35 min", difficulty: "Easy", category: "cajun",
    ...
    products: [
      { name: "Velveeta Cheese", query: "Velveeta original cheese" },
      { name: "Cajun Seasoning", query: "cajun seasoning Tony Chacheres" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
  { id: "bisque", title: "Crawfish Bisque", time: "2+ hrs", difficulty: "Hard", category: "cajun",
    ...
    products: [
      { name: "Cajun Seasoning", query: "cajun seasoning Tony Chacheres" },
      { name: "Stock Pot 12-Qt", query: "stock pot 12 quart stainless steel" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
  { id: "pie", title: "Crawfish Pie", time: "60 min", difficulty: "Medium", category: "cajun",
    ...
    products: [
      { name: "Pie Crusts (2-pack)", query: "refrigerated pie crusts 2 pack" },
      { name: "Cajun Seasoning", query: "cajun seasoning Tony Chacheres" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
  { id: "poboy", title: "Fried Crawfish Po'Boy", time: "25 min", difficulty: "Easy", category: "cajun",
    ...
    products: [
      { name: "Zatarain's Fish Fri", query: "Zatarains fish fri seasoned" },
      { name: "Cast Iron Skillet", query: "cast iron skillet 12 inch Lodge" },
      { name: "Crawfish Tail Meat", query: "crawfish tail meat frozen Louisiana" },
    ] },
];

export const TIPS = [
  { title: "Purge Your Crawfish", body: "Dump into a cooler, run clean water over them, change 3-4 times until clear. Remove dead ones (straight tails). Let sit in clean water an hour if you have time.", faq: "How do you purge crawfish before a boil?" },
  { title: "Season the Water First", body: "Seasonings, lemons, oranges, garlic, onions boiling 10-15 min before anything else. Use both powder and liquid concentrate for best results.", faq: "When do you add seasoning to a crawfish boil?" },
  { title: "Add Vinegar to the Pot", body: "A cup of white distilled vinegar makes shells easier to peel and cuts the lingering smell. Game changer for indoor boils.", faq: "Why add vinegar to a crawfish boil?" },
  { title: "Don't Overcook", body: "3-5 min of actual boiling after water returns to rolling boil. Bigger crawfish go longer. Bright red + floating = done. The soak does the rest.", faq: "How long do you boil crawfish?" },
  { title: "The Soak Is Everything", body: "Kill heat, add ice/frozen corn. Sit 15-30 min. When they start sinking, they've absorbed all they can.", faq: "How long should crawfish soak after boiling?" },
  { title: "Plan 3 lbs Per Person", body: "Heavy eaters: 5+ lbs. Light: 2 lbs. Budget 3 as baseline. Takes 6-8 lbs whole crawfish to get 1 lb tail meat.", faq: "How many pounds of crawfish per person?" },
  { title: "Check Your Crawfish", body: "Most should be alive and active before buying. Straight tails after cooking = dead going in. Toss those.", faq: "How do you tell if crawfish are good before cooking?" },
  { title: "Save the Leftovers", body: "Peel while warm. Store tails 2-3 days in fridge. Freeze heads/shells for stock. The fat is liquid gold for etouffee.", faq: "How do you store leftover crawfish?" },
  { title: "Use Oranges Too", body: "Oranges add sweetness that balances heat. Squeeze juice in first, toss halves in. Some use grapefruit -- citrus breaks down shells.", faq: "What fruit do you add to a crawfish boil?" },
];
